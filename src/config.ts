...
export const EMULATE_MEDIA_TYPE_SCREEN_ENABLED = process.env.HCPDF_EMULATE_MEDIA_TYPE_SCREEN_ENABLED ?? ''
export const ACCEPT_LANGUAGE = process.env.HCPDF_ACCEPT_LANGUAGE ?? ''
export const TEST_TARGET_URL = process.env.HCPDF_TEST_TARGET_URL ?? 'https://www.google.com'
export const TEST_POST_HTML = process.env.HCPDF_TEST_POST_HTML ?? '<html><head><title>hc-pdf-sever</title></head> <body><p>this is <b>hc-pdf-server</b> test!</p></body></html>'
